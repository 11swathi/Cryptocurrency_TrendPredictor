...
def get_crypto_data(symbol, days=90):
    ...
    candlestick_data.columns = ['min_price', 'max_price', 'opening_price', 'closing_price']
...
def main():
    ...
    st.table(past_5_days_data[['Date', 'min_price', 'max_price', 'opening_price', 'closing_price']].reset_index(drop=True))
